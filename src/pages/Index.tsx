          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              <motion.div 
                ...
                className="glass-card rounded-2xl p-8 border-hero-light/10"
              >
                <div className="w-12 h-12 rounded-full bg-hero-light/10 flex items-center justify-center mb-4 text-primary">
